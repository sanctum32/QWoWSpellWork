...
struct ItemSparseEntry
{
    ...
    std::array<uint32_t, MAX_ITEM_PROTO_SOCKETS> Content;               // 121 - 124
    int32_t      SocketBonus;                                           // 125
    int32_t      GemProperties;                                         // 126
    float        ArmorDamageModifier;                                   // 127
    int32_t      Duration;                                              // 128
    uint32_t     ItemLimitCategory;                                     // 129
    int32_t      HolidayID;                                             // 130
